...
<main id="main">
  ...
  <section class="breadcrumbs">
      <div class="container">
          ...
          <h2>Konfirmasi Jumlah Pesanan</h2>
          <ol>
          <li><a href="/">Home</a></li>
              <li>Pemesanan</li>
  ...
  <section class="inner-page portfolio">
    <div class="container" data-aos="fade-up">
      <form action="/order/save" method="POST" class="portfolio">
      {{ csrf_field() }}
              ...
              <input type='Number' name='order_id' value="{{$order_id}}"hidden>
                ...
                @foreach ($customer_order as $order )
                  <tr>
                    ...
                    <td class="align-middle text-center"><input type='Number' name='quantity[]' placeholder='Jumlah pesanan' required> </td>
                    <td class="align-middle text-center"><input type='Number' name='id[]' value="{{$order->id}}"hidden> </td>
                  </tr>
                @endforeach
                </tbody>     
              </table>
